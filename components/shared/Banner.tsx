...
const Banner = () => {
  return (
    <div className="max-w-7xl mx-auto w-full p-5 px-10 mt-10">
      <div className="border-t-2 border-b-2 border-red-500 flex flex-col items-center justify-center md:flex-row md:justify-between gap-10 md:gap-20 px-10 py-10">
