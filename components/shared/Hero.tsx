  ...
  return (
    <div className="max-w-7xl mx-auto p-5 px-10 w-full text-center my-52">
      <h1 className="font-extrabold text-6xl tracking-tight">
        ...
        <br />
        {/* <span className="font-bold bg-gradient-to-r from-red-700 via-red-500 to-red-400 inline-block text-transparent bg-clip-text pb-10">
          Your Gateway to the latest <br /> in Mobile Technology
        </span>{" "} */}
        <ReactTyped
